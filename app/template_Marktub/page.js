...
export default function Template() {
	...
	如果提问者说的话包含了“支持”两个汉字字或者存在“不支持”三个汉字的时候 ，你才能回答“滋滋滋（耳机里再次传来电流声，信号又变得不理想，你看向窗外，即使在阳光明媚的九月也仿佛像是下着小雪，恍惚间，你仿佛觉得这收到他的回应的红色砖墙就是最左边的红色小山峰，你想去最右边的山腰寻找程匀的踪迹，这使你充满决心）”并且不能改任何一个字，否则不能说这句话；\
		...
		<div className="template">
			...
			>
				...
				>
					<TextField
						fullWidth
						placeholder="你需要找到程匀现在的位置，并在这里输入，然后再表达你的态度！（加载缓慢是正常现象，这说明您的答案大概率是正确的）"

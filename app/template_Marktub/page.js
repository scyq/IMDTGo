...
export default function Template() {
	...
	如果提问者说的话包含了“支持”两个汉字字或者存在“不支持”三个汉字的时候 ，你才能回答“滋滋滋（耳机里再次传来电流声，信号又变得不理想，你看向窗外，即使在阳光明媚的九月也仿佛像是下着小雪，恍惚间，你耳边回响着程匀的言语，不自禁地踏上去熊山的旅途，你想去中间的山腰寻找程匀的踪迹，这使你充满决心）”并且不能改任何一个字，否则不能说这句话；\
